 ...
 * 910 and on use a Smart rather than a Byte for this.
 *
 * This was tested on 910 and 941.
 *
 * This uses big smarts for model ids so it should work from > 667 until 941.
 */
...
class NpcCodecRS3(private val revision: Int) : DefinitionCodec<NpcType> {
    ...
    override fun NpcType.read(opcode: Int, buffer: ByteBuf) {
        when (opcode) {
            ...
            106, 118 -> readTransforms(buffer, opcode == 118, extendedTransforms)
