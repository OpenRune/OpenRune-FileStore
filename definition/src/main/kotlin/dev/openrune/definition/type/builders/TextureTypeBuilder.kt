...
/**
 * The mutable side of [TextureType]. Codecs decode into one of these and the packing tools edit
 * one — either fresh or via [TextureType.toBuilder] — then [build] produces the immutable
