...
/**
 * The mutable side of [IdentityKitType]. Codecs decode into one of these and the packing tools
 * edit one — either fresh or via [IdentityKitType.toBuilder] — then [build] produces the
