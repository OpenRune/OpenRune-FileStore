...
import dev.openrune.cache.worldmap.worldmap.WorldMapElement
import dev.openrune.cache.worldmap.worldmap.ground.MapsquareGroundArea
import dev.openrune.cache.worldmap.worldmap.ground.MapsquareId
import dev.openrune.cache.worldmap.worldmap.providers.*
import dev.openrune.cache.worldmap.worldmap.rasterizer.font.WorldMapFontsRepository
import dev.openrune.cache.worldmap.worldmap.rasterizer.utils.WorldMapLabelSize
import dev.openrune.cache.worldmap.worldmap.rasterizer.utils.WorldMapTextLabel
...
object WorldMapRenderer {
    ...
    private fun drawSpriteElement(
        ...
        val sprite = providers.spriteProvider.getSprites()?.get(element.graphic)?.sprites?.first() ?: return
        ...
        sprite.drawTransparentBackgroundSprite(rasterizer2D, x + horizontalOffset, y + verticalOffset)
    }
