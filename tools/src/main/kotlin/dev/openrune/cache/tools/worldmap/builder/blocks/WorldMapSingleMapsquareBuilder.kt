 ...
 */
class WorldMapSingleMapsquareBuilder(val cache: org.openrs2.cache.Cache,private val section: MapsquareSingleSection) : WorldMapBlockBuilder<WorldMapMapsquare> {
